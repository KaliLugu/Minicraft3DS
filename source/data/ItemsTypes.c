...
static const ItemData _vanillaDefs[] = {
    ...
    ITEM_ENTRY("ITEM_ANVIL", "Anvil", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_CHEST", "Chest", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_OVEN", "Oven", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_FURNACE", "Furnace", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_WORKBENCH", "Workbench", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_LANTERN", "Lantern", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_LOOM", "Loom", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ITEM_ENTRY("ITEM_ENCHANTER", "Enchanter", ITEM_CAT_FURNITURE, false, {.generic = {false}}),
    ...
    ITEM_ENTRY("TOOL_BUCKET", "Bucket", ITEM_CAT_TOOL, false, {.tool = {2}}),
