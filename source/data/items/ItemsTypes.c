...
static const ItemData _vanillaDefs[] = {
    ...
    ITEM_ENTRY("ITEM_SCROLL_UNDYING", "Undying Scroll ", ITEM_CAT_SPELL, true ,18, 21, {.spell = {5, 0} }),
    ITEM_ENTRY("ITEM_SCROLL_REGENERATION", "Regeneration Scroll", ITEM_CAT_SPELL, true, 18, 21, {.spell = {5, 1}}),
    ITEM_ENTRY("ITEM_SCROLL_SPEED", "Speed Scroll", ITEM_CAT_SPELL, true, 18, 21, {.spell = {5, 2}}),
    ITEM_ENTRY("ITEM_SCROLL_STRENGTH", "Strength Scroll", ITEM_CAT_SPELL, true, 18, 21, {.spell = {5, 3}}),
    ITEM_ENTRY("ITEM_SCROLL_SHIELDING", "Shielding Scroll", ITEM_CAT_SPELL, true, 18, 21, {.spell = {5, 4}}),
    ITEM_ENTRY("ITEM_SCROLL_NIGHTVISION", "Nightvision Scroll", ITEM_CAT_SPELL, true, 18, 21, {.spell = {5, 5}}),
